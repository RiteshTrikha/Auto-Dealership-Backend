...
class Appointment(db.Model):
    ...
    customer = relationship('app.customer.models.Customer', backref='appointments')
    user = relationship('app.user.models.User', backref='appointments')
    time_slot = relationship('TimeSlot' , backref='appointments')
    
    #get test drive appointments by customer id
    @classmethod
    def get_test_drive_appointments_by_customer_id(cls, customer_id):
        try:
            return db.session.query(Appointment).filter_by(customer_id=customer_id, appointment_type=2).all()
    ...
    def get_service_appointments_by_customer_id(cls, customer_id):
        try:
            return db.session.query(Appointment).filter_by(customer_id=customer_id, appointment_type=1).all()
        except Exception as e:
            raise e
    ...
    def get_test_drive_appointments(cls):
        try:
            return db.session.query(Appointment).filter_by(appointment_type=2).all()
        except Exception as e:
            raise e
    ...
    def get_service_appointments(cls):
        try:
            return db.session.query(Appointment).filter_by(appointment_type=1).all()
        except Exception as e:
            raise e
...
class TimeSlot(db.Model):
    ...
    def get_test_drive_time_slots(cls):
        try:
            return db.session.query(TimeSlot).filter_by(time_slot_type=2).all()
        except Exception as e:
            raise e
    ...
    def get_service_time_slots(cls):
        try:
            return db.session.query(TimeSlot).filter_by(time_slot_type=1).all()
        except Exception as e:
            raise e
...
class Service_Ticket(db.Model):
    ...
    user = relationship('app.user.models.User' , backref='negotiations')
    time_slot_id = relationship('app.scheduling.models.TimeSlot' , backref='negotiations')
    ...
    def get_service_ticket_by_service_ticket_id(cls, service_ticket_id):
        try:
            return db.session.query(Service_Ticket).filter_by(service_ticket_id=service_ticket_id).first()
        except Exception as e:
            raise e
    ...
    def get_all_service_tickets_by_customer_id(cls, customer_id):
        try:
            return db.session.query(Service_Ticket).filter_by(customer_id=customer_id).all()
        except Exception as e:
            raise e
    ...
    def get_all_service_tickets_by_user_id(cls, user_id):
        try:
            return db.session.query(Service_Ticket).filter_by(user_id=user_id).all()
        except Exception as e:
            raise e
    ...
    def get_all_service_tickets_by_customer_vehicle_id(cls, customer_vehicle_id):
        try:
            return db.session.query(Service_Ticket).filter_by(customer_vehicle_id=customer_vehicle_id).all()
        except Exception as e:
            raise e
    ...
    def get_all_service_tickets_by_time_slot_id(cls, time_slot_id):
        try:
            return db.session.query(Service_Ticket).filter_by(time_slot_id=time_slot_id).all()
        except Exception as e:
            raise e
    ...
    @classmethod
    def create_service_ticket(self, customer_id, user_id, customer_vehicle_id, time_slot_id, customer_notes, technician_notes, status):
        try:
            service_ticket = Service_Ticket(customer_id=customer_id, user_id=user_id, customer_vehicle_id=customer_vehicle_id, time_slot_id=time_slot_id, customer_notes=customer_notes, technician_notes=technician_notes, status=status)
    ...
    def add_technician_notes_to_service_ticket(self, service_ticket_id, technician_notes):
        try:
            service_ticket = db.session.query(Service_Ticket).filter_by(service_ticket_id=service_ticket_id).first()
...
class Service(db.Model):
    ...
    def get_service_by_service_id(cls, service_id):
        try:
            return db.session.query(Service).filter_by(service_id=service_id).first()
        except Exception as e:
            raise e
    ...
    def get_service_by_service_type(cls, service_type):
        try:
            return db.session.query(Service).filter_by(service_type=service_type).first()
        except Exception as e:
            raise e
...
class Service_Ticket_Service(db.Model):
    ...
    def get_all_services_by_service_ticket_id(cls, service_ticket_id):
        try:
            return db.session.query(Service_Ticket_Service).filter_by(service_ticket_id=service_ticket_id).all()
        except Exception as e:
            raise e
    ...
    def get_all_service_tickets_by_service_id(cls, service_id):
        try:
            return db.session.query(Service_Ticket_Service).filter_by(service_id=service_id).all()
        except Exception as e:
            raise e
    ...
    def update_service_ticket_service(self, service_ticket_id, service_id):
        try:
            service_ticket_service = db.session.query(Service_Ticket_Service).filter_by(service_ticket_id=service_ticket_id, service_id=service_id).first()
            return service_ticket_service
        except Exception as e:
            raise e
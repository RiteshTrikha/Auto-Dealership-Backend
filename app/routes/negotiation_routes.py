...
def create_negotiation():
    ...
    try:
        ...
        negotiation_id = NegotiationService().create_negotiation(vehical_id, customer_id, offer_price)
        return jsonify(
            status='success', 
...
@routes_bp.route('/api/negotiation/negotiations/<int:customer_id>', methods=['GET'])
def get_negotiations(customer_id):
    ...
    """
    try:
        negotiations = NegotiationService().get_negotiations(customer_id)
        if negotiations is None:
            return jsonify(
                status='fail', 
                data=[], 
...
@routes_bp.route('/api/negotiation/negotiation/<int:negotiation_id>', methods=['GET'])
...
@routes_bp.route('/api/negotiation/negotiation/<int:negotiation_id>/counter', methods=['POST'])
...
@routes_bp.route('/api/negotiation/negotiation/<int:negotiation_id>/offer', methods=['POST'])
def additional_offer(negotiation_id):
  ...
  #accept offer
@routes_bp.route('/api/negotiation/negotiation/<int:negotiation_id>/accept', methods=['POST'])
...
@routes_bp.route('/api/negotiation/negotiation/<int:negotiation_id>/reject', methods=['POST'])
